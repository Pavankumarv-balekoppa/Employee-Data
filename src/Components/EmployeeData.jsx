...
const EmployeeData = () => {
    ...
    return (
        <div>
            <div className="search_Bar mt-5 ps-5">
            <input  type="text" placeholder="Enter name to search" value={filterVal} onChange={(e) => handlefilter(e)} className="rounded w-50 mx-auto p-2"/>
            </div>
            <table className="table  w-75 m-auto" border="5px">
             <tr>
                                        <th scope="col" >id</th>
